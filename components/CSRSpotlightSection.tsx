      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4 sm:mb-6 md:mb-8">
            {t("earn.csrSpotlight.title.part1")}{" "}
            <span className="text-pink-100">{t("earn.csrSpotlight.title.part2")}</span>
          </h2>
          <p className="text-lg text-white/90 max-w-4xl mx-auto leading-relaxed">
            {t("earn.csrSpotlight.description")}
          </p>
        </motion.div>
        ...
        >
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 max-w-4xl mx-auto border border-white/20">
            ...
            >
              {t("earn.csrSpotlight.cta.title.part1")}{" "}
              <span className="text-pink-100">{t("earn.csrSpotlight.cta.title.part2")}</span>
            </motion.h3>
            <motion.div
            ...
            >
              <motion.button
                ...
                transition={{ duration: 0.8, delay: 0.6 }}
              >
                {t("earn.csrSpotlight.cta.primary")}
              </motion.button>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                ...
                transition={{ duration: 0.8, delay: 0.6 }}
              >
                {t("earn.csrSpotlight.cta.secondary")}
              </motion.button>
            </motion.div>
          </div>
        </motion.div>
