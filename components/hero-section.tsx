...
export function HeroSection() {
  ...
  const stats: Stat[] = [
    ...
    { icon: FiShield, value: "100%", label: t("hero.stats.safeRides") },
    { icon: FiStar, value: "4.9", label: t("hero.stats.rating") },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              {[
                t("hero.feature.verifiedDrivers"),
                t("hero.feature.emergencySupport"),
                t("hero.feature.gpsTracking"),
                t("hero.feature.transparentPricing"),
              ].map((item, i) => (
                <div
                  key={i}
